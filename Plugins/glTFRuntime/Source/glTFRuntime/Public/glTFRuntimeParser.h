...
//DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FglTFRuntimeOnPrimitiveLoaded, const TArray<UMaterialInterface*>&, MaterialVariants);
...
public:
	...
	//FglTFRuntimeOnPrimitiveLoaded OnPrimitiveLoaded;
	...
	//custom
	TArray< UMaterialInterface*> GetMaterialVariants();
	//end custom
...
protected:
	...
	TArray< UMaterialInterface*> MaterialsVariantsArray;
